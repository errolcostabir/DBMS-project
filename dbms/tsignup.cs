...
namespace dbms
{
    public partial class tsignup : Form
    {
        ...
        public bool UseSystemPasswordChar { get; private set; }
        ...
        {
            if (fname.Text == "First Name" || lname.Text == "Last Name" || phone_no.Text == "Phone Number" || dept.Text == "Department" || username.Text == "Username" || password.Text == "Password")
            {
              ...
              if (password.Text == confirm_pass.Text)
            {
                ...
                QUERY = "select * from t_signup where username='" + username.Text + "' ";
                CON1.Open();
                ...
                {
                    CON1.Open();
                    QUERY = "Insert into t_signup(fname,lname,phone_no,dept,username,password) values('" + fname.Text + "','" + lname.Text + "','" + phone_no.Text + "','" + dept.Text + "', '" + username.Text + "','" + password.Text + "')";
                    CMD = new OracleCommand(QUERY, CON1);
        ...
        void clear()
        {
            fname.Text = lname.Text = phone_no.Text = dept.Text = username.Text = password.Text = " ";
        }
        void next()
        {
        ...
        private void tsignup_Enter(object sender, EventArgs e)
        {

        }

        private void dept_Enter_1(object sender, EventArgs e)
        {
        ...
        private void tsignup_Load(object sender, EventArgs e)
        {
